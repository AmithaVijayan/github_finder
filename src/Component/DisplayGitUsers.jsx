            ...
            <section className="card">
                {loading === true ? (
                    ...
                    <div className="col-md-3">
                        ...
                        <div style={{textAlign : "left" , padding : "4 px 10px"}}>{users.bio}
                        <span className="badge badge-primary float-right">
                            {users.hireable === true  ? "hireable" : "leaner"}
                        </span>
                        </div>
                    </div>
                        ...
                        {loading ? repos.data.map(repo =>(
                            <div key={repo.id}>
                                ...
                                <ul>
                                    ...
                                    <li>Clone Repo <a href={repo.clone_url}>clone</a></li>
